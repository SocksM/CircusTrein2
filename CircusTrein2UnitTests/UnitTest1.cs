...
namespace CircusTrein2UnitTests
{
    public class Tests
    {
        ...
        {
            Cart cart1 = new Cart();
            cart1.AddAnimalNoRestictions_ONLY_FOR_UNIT_TESTS(hl); //hm,true
            Cart cart2 = new Cart();
            cart2.AddAnimalNoRestictions_ONLY_FOR_UNIT_TESTS(hs); //hm,true
            Cart cart3 = new Cart();
            cart3.AddAnimalNoRestictions_ONLY_FOR_UNIT_TESTS(hl);
            cart3.AddAnimalNoRestictions_ONLY_FOR_UNIT_TESTS(hl); //hm,false
            Cart cart4 = new Cart();
            cart4.AddAnimalNoRestictions_ONLY_FOR_UNIT_TESTS(hl);
            cart4.AddAnimalNoRestictions_ONLY_FOR_UNIT_TESTS(hs); //hm, false
